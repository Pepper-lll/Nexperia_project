...
parser.add_argument('--data', metavar='DIR', default='/import/home/xliude/dataset/tiny-imagenet-200',
...
parser.add_argument('--data-set', default='CIFAR10', choices=['CIFAR10', 'CIFAR100', 'IMNET', 'INAT', 'INAT19', 
                        ...
                        'IMB_CIFAR10_exp01', 'IMB_CIFAR10_exp002', 'IMB_CIFAR10_exp001', 'Nex_trainingset'],
...
parser.add_argument('--gpu', default=None, type=int,
                    help='GPU id to use.')
parser.add_argument('--multiprocessing-distributed', default='store_true',
...
parser.add_argument('--pretrain_type', default='SSL', type=str, choices=['SL', 'SSL'],
                    help='type of pretrain, SL means supervised pretrain, \
                    SSL means slef supervised pretrain')
parser.add_argument('--loss', default='CE', type=str, choices=['CE', 'MSE'],
                    help='type of loss to train the classifier, \
                        CE: cross entropy, MSE: mean square loss (l2 loss)')
parser.add_argument('--train_rule', default='', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.data_set == 'tiny_IMNET':
        ...
        train_dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=True, transform=train_transform)
        val_dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=False, transform=val_transform)
        args.nb_classes = 10
        ...
        train_dataset = IMBALANCECIFAR10(root='/import/home/xliude/vs_projects/data', imb_type='step', imb_factor=0.01,
                                    rand_number=0, train=True, download=True, transform=train_transform)
        val_dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=False, transform=val_transform)
        args.nb_classes = 10
    elif args.data_set == 'Nex_trainingset':
        ...
        train_dataset = textReadDataset(data_dir, name_train, labels_train, train_transform)
        val_dataset = textReadDataset(data_dir, name_val, labels_val, val_transform)
        args.nb_classes = 9
            ...
            if output_dir:
                ...
                if is_best:
                    save_checkpoint({
                        ...
                        'best_acc1': best_acc1,
                        'optimizer' : optimizer.state_dict(),
                    }, is_best, filename=output_dir / 'checkpoint_best.pth')
            if epoch == args.start_epoch:
                sanity_check(model.state_dict(), args.pretrained, args.pretrain_type)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if args.loss == 'MSE':
            one_hot_target = get_one_hot(target, args.nb_classes)
            print(one_hot_target.size(), one_hot_target[0])
...
def sanity_check(state_dict, pretrained_weights, pretrain_type):
    """
    ...
    if pretrain_type == 'SSL':
        ...
        # print(list(state_dict_pre.keys())[:10])
        for k in list(state_dict.keys()):
            # only ignore fc layer
            if 'fc.weight' in k or 'fc.bias' in k:
                continue
