...
_C.DATA.DATA_PATH = ''
# Dataset name
#choices: 'Nex_trainingset', 'CIFAR10', 'IMB_CIFAR10_exp001', 'IMB_CIFAR10_step001'
_C.DATA.DATASET = 'IMB_CIFAR10_step001'
# Input image size
...
def update_config(config, args):
    ...
    # output folder
    config.OUTPUT = os.path.join(config.OUTPUT, config.MODEL.NAME, config.DATA.DATASET, config.TAG)
