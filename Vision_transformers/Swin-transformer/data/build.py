...
def build_dataset(is_train, config):
    ...
    if config.DATA.DATASET == 'imagenet':
        ...
        dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=is_train, transform=transform)
        nb_classes = 10
    elif config.DATA.DATASET == 'IMB_CIFAR10_exp001':
        if is_train:
            dataset = IMBALANCECIFAR10(root='/import/home/xliude/vs_projects/data', imb_type='exp', imb_factor=0.01,
                                    rand_number=0, train=is_train, download=True, transform=transform)
        else:
            dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=is_train, transform=transform)
        nb_classes = 10
    elif config.DATA.DATASET == 'IMB_CIFAR10_step001':
        if is_train:
            ...
            dataset = datasets.CIFAR10(root='/import/home/xliude/vs_projects/data', train=is_train, transform=transform)
        nb_classes = 10
    elif config.DATA.DATASET == 'Nex_trainingset':
