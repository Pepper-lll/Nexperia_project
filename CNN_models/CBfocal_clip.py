...
import sys
import os
from losses import CrossEntropy, BalancedSoftmaxCE, ClassBalanceFocal
...
if __name__ == "__main__":
    ...
    criterion = ClassBalanceFocal(para_dict)
...
# ============================ step 5/5 训练 ============================
    ...
    for epoch in range(start_epoch + 1, MAX_EPOCH):
        ...
        loss_train, acc_train, mat_train, y_true_train, y_outputs_train, logits_train = ModelTrainer.train(train_loader, resnet_model, None, criterion, optimizer,
