...
from common_tools import ModelTrainer, show_confMat, \
    plot_line, cal_focal_loss_alpha, cal_loss_eachClass,\
    dataset_info_no_others,  dataset_info, set_seed, correct_label
...
if __name__ == "__main__":
    ...
    backbone = "_Res50"
    method = "_LDAMloss0.6_"
    data_name = "_NexTrainSet_2classes"
    ...
    # weight = None
    cls_num_list = [24587, 39446]
    # cls_num_list = [2, 1830, 748, 532, 39446, 3399, 7527, 166, 10383] #删掉others类

    criterion = LDAMLoss(cls_num_list=cls_num_list, max_m=0.3)
...
# ============================ step 5/5 训练 ============================
    ...
    for epoch in range(start_epoch + 1, MAX_EPOCH):
        ...
        #     loss_class_train_dict[class_names[i]] = loss_class_train[i]
        #     loss_class_val_dict[class_names[i]] = loss_class_val[i]
