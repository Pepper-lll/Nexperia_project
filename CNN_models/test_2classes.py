...
def cal_auc(y_true_train, y_outputs_train, out_dir):
    ...
    return roc_auc, pr_auc, fpr_dict, threshhold980, y_score[:, 0]
...
if __name__ == "__main__":
    ...
    ###++++++++ for CE
    model_dir = '08-31_19-06_Res50_CE_2classes'
    data_dir = '/import/home/share/from_Nexperia_April2021/Mar2021/'
    backbone = "_Res50"
    method = "_CE_2classes"
    test_data_name = "_Mar"
    #++++++++ hyper parameters end ++++++++#

    name_test1, labels_test1 = dataset_info(join(data_dir, 'Mar2021_train_down.txt'))
    name_test2, labels_test2 = dataset_info(join(data_dir, 'Mar2021_val_down.txt'))
    name_test3, labels_test3 = dataset_info(join(data_dir, 'Mar2021_test_down.txt'))
